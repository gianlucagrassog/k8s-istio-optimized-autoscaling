...
def compare_node_cpu(cpu_1, cpu_2):
    cpu_1 = filter_data_node(cpu_1, '192.168.49.2:9100', '2023-03-12 12:30:03')
    cpu_2 = filter_data_node(cpu_2, '192.168.49.2:9100', '2023-03-12 11:59:47')

    time_range = np.arange(0, 1100, 5)
...
def compare_replicas(replicas_1,replicas_2):
    ...
    replicas_1 = filter_data_replicas(replicas_1, '2023-03-12 12:30:03')
    replicas_2 = filter_data_replicas(replicas_2, '2023-03-12 11:59:47')
    ...
    ax1.plot(time_range, replicas_1, label='HPA 1: Cpu based')
...
def compare_rt(latency_df1,latency_df2):
    ...
    ts1 = ts1[ts1['timestamp'] <= pd.Timestamp('2023-03-12 12:30:03')]
    ts2 = latency_df2[(latency_df2['source_app'] == 'loadgenerator') & (
        latency_df2['destination_app'] == 'frontend')]
    ts2 = ts2[ts2['timestamp'] <= pd.Timestamp('2023-03-12 11:59:47')]
...
if __name__ == '__main__':
    ...
    # Read data from csv
    latency_df_6 = read_data(
        '6_latency_by_app_2m_300_2023-03-12 12:00:33.csv')
    cpu_df_6 = read_data(
        '6_node_cpu_percentance300_2023-03-12 12:00:33.csv')
    replicas_6 = read_data(
        '6_replicas_available_300_2023-03-12 12:00:33.csv')

    latency_df_6_2 = read_data(
        '6.2_latency_by_app_2m_300_2023-03-12 12:30:21.csv')
    cpu_df_6_2 = read_data(
        '6.2_node_cpu_percentance300_2023-03-12 12:30:21.csv')
    replicas_6_2 = read_data(
        '6.2_replicas_available_300_2023-03-12 12:30:21.csv')
    ...
    compare_node_cpu(cpu_df_6_2, cpu_df_6)
    compare_replicas(replicas_6_2,replicas_6)
    compare_rt(latency_df_6_2,latency_df_6)

...
def compare_node_cpu(cpu_1, cpu_2):
    cpu_1 = filter_data_node(cpu_1, '192.168.49.2:9100', '2023-03-05 15:22:21')
...
def compare_replicas(replicas_1,replicas_2):
    ...
    replicas_1, replicas_1_users = filter_data_replicas(replicas_1, '2023-03-05 15:22:21')
...
def compare_rt(latency_df1,latency_df2):
    ...
    ts1 = ts1[ts1['timestamp'] <= pd.Timestamp('2023-03-05 15:22:21')]
